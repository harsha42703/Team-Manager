...
const AllTeams = () => {
  ...
  return (
   <>
    <section className="mx-auto w-full bg-cyan-100 max-w-7xl px-4 py-4 mt-36">
        ...
        <div className="mt-6 flex flex-col">
          <div className="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div className="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
              <div className="overflow-hidden border border-cyan-700 md:rounded-lg">
                <table className="min-w-full divide-y divide-cyan-700">
                  ...
                  <tbody className="divide-y divide-cyan-700 bg-white">
